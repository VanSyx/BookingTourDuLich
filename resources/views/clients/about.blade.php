        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/Orange-colored-cat-yawns-displaying-teeth.webp') }}" alt="Guide">
                    <div class="content">
                        <h6>Võ Minh Nhật</h6>
                        <span class="designation">Dev</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-sm-6">
