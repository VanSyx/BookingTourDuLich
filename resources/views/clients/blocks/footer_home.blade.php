                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> 566 núi thành, Hòa Cường Nam, Hải Châu, Đà Nẵng</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:minhdien.dev@gmail.com">admin@gmail.com</a></li>
                            <li><i class="fal fa-clock"></i> Thứ 2 - Thứ 6, 08am - 05pm</li>
                            <li><i class="fal fa-phone-volume"></i> <a href="callto:+123456789">+123456789</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="copyright-text text-center text-lg-start">
                        <p>@Copy 2026 <a href="{{ route('home') }}">Travela</a>, All rights reserved</p>
                    </div>
                </div>
